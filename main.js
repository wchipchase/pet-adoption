...
pets.forEach((pet) => {
    ...
    domString += `  <div class="petName"><h2>${pet.name}</h2></div>`;
    domString += `  <div class="image"><img src=${pet.imageUrl}></div>`;
    domString += `  <div class="color"><p>${pet.color}</p></div>`;
    domString += `  <div class="special_skill"><p>Pet Special Skill: ${pet.specialSkill}</p></div>`;
    domString += `  <div class="petType"><h2> ${pet.type}</h2></div>`;
    domString += `</div>`;
    })
